        ...
        try {
            ...
            mutation{
                mutationWithAuth(token:"auto"){
                  fabricate{
                    createChallenge(challenger:"${challenge.challenger}" amount:${challenge.amount} contender:"643e502e746d5ecbaa4936b8" status:PENDING roomCode:"213" game:"64413054d74babfdb353e6b0" ){
                      id
                      challenger{
                        id
                        name
