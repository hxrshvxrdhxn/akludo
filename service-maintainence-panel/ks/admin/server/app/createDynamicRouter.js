...
module.exports = function createDynamicRouter(keystone) {
	...
	// get user followup
	router.get('/api/dash/stats', require('../api/dashCounts'));
	...
	router.post('/api/update-status/:list/:id', initList, require('../api/item/updateStatus'));
	...
	router.get('/api/:list/availed/:customerId', initList, require('../api/offer/availed'));
	router.get('/api/:list/aliases/:customerId', initList, require('../api/offer/aliases'));
