...
function getOptions () {
	var ops = {
		...
		uiElements: [],
		rowButtons: this.options.rowButtons,
		rowButtonsDynamic: this.options.rowButtonsDynamic,
		hideDrilldown: this.options.hideDrilldown,
		hideSearchInDrilldown: this.options.hideSearchInDrilldown
	};
