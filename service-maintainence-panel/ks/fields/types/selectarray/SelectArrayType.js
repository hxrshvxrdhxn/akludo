 ...
 * @api public
 */
function selectarray (list, path, options) {
	...
	selectarray.super_.call(this, list, path, options);
}
selectarray.properName = 'SelectArray';
util.inherits(selectarray, FieldType);

/**
 * Formats the field value
 */
selectarray.prototype.format = function (item, separator) {
 ...
 */
selectarray.prototype.addFilterToQuery = function (filter) {
	var query = {};
 ...
 */
selectarray.prototype.validateInput = function (data, callback) {
 ...
 */
selectarray.prototype.validateRequiredInput = function (item, data, callback) {
	var value = this.getValueFromData(data);
	var result = false;
 ...
 * Deprecated
 */
selectarray.prototype.inputIsValid = function (data, required, item) {
	var value = this.getValueFromData(data);
	if (required) {
 ...
 */
selectarray.prototype.updateItem = function (item, data, callback) {
	var value = this.getValueFromData(data);
	if (value === undefined || value === null || value === '') {
		value = [];
	}
